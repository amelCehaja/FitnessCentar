...
{
    public class AjaxDodajDanVjezbaVM
    {
        public List<SelectListItem> Vjezbe { get; set; }
        [Required(ErrorMessage = "Vjezba je obavezna!")]
        [Remote("PostojanjeVjezbe", "AdministracijaValidacija", HttpMethod = "POST", ErrorMessage = "Nevalja")]
